...
<html lang="en">
    ...
    <body>
        ...
        <div class="main-div vh-100 vw-100 d-flex align-items-center justify-content-center "
            ...
            <div class="d-flex shadow-lg flex-wrap w-100 h-auto overflow-hidden" style="max-width: 900px;">
                ...
                <div class="col-12 col-md-6 d-flex align-items-center justify-content-center flex-column p-4 bg-white">
                    <div class="picture-div mb-4 d-flex justify-content-center align-items-center"
                        style="height:350px; width:350px;"class="picture-div mb-4 d-flex justify-content-center align-items-center"
                        style="max-width: 100%; height: auto;">
                        <img src="{{ asset('pictures/BizmatechLogo.png') }}" alt="Bizmatech Logo" class="img-fluid"
                ...
                <div class="col-12 col-md-6 d-flex align-items-center justify-content-center flex-column p-5"
                    ...
                    <form method="POST" action="{{ route('login') }}"
                        ...
                        <div class="mb-4 w-100">
                            ...
                            <small class="text-muted" style="font-size:0.6rem;">Explore top-quality Vendo Computers for
                                all your needs.</small>
                        </div>
                        <div class="col w-100 mb-2">
                            <label for="email" :value="__('Email')" class="mb-2">Email</label>
                            <input id="email" class="form-control" aria-label="Username" required
                                aria-describedby="basic-addon1" type="email" name="email" :value="old('email')"
                        ...
                        <div class="col  w-100 mb-3">
                            ...
                            <input id="password" type="password" name="password" required
                                autocomplete="current-password" class="form-control" aria-label="Username"
                            ...
                            <div class="w-100 d-flex align-items-center justify-content-end mt-2">
                                <div class="form-check ml-3">
                                    <input class="form-check-input" id="showPassword" type="checkbox" value=""
                                        aria-label="Checkbox for following text input" id="showPassword">
