    ...
    <div class="d-flex h-100 w-100 gap-2 p-1">
        ...
        <div class="d-flex flex-column gap-2">
            ...
            <div class="d-flex justify-content-evenly gap-2">
                ...
                {{-- Add New --}}
                <button type="submit" id="new-Quote" form="customerForm" class="btn btn-success addButton"
                    ...
                    <span id="buttonSpinner-Quote" class="spinner-border spinner-border-sm d-none" role="status"
                        aria-hidden="true"></span>
                </button>


                {{-- Save --}}
                <button type="submit" id="saveBtn-customers" form="customerForm" class="btn btn-info saveButton"
                    style="font-size:0.6rem; width:80px; border-radius:3px;">
                    <i class="fa-solid fa-floppy-disk" id="saveIcon"></i>
                    <span id="buttonText-customer">{{ __('Save') }}</span>
                    <span id="buttonSpinner-customer" class="spinner-border spinner-border-sm d-none" role="status"
                        aria-hidden="true"></span>
                </button>
        ...
        <div class="d-flex flex-column gap-2 w-100 h-100">
            {{-- Content --}}
            <div class="border rounded p-3 overflow-auto custom-scrollbar" style="height: 80vh; max-width:1000px; "
                ...
                <div id="detailsForPrint">
                    ...
                    <div id="deatailsForHeaderAndFooter">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="customerDetails d-flex flex-column gap-2"style="font-size:0.8rem;flex-basis:70%;">
                                <form class="customerForm">
                                    ...
                                    <div class="customerName d-flex w-100 align-items-center">
                                        ...
                                        <input type="text" id="customerName" class="flex-grow-1"
                                    ...
                                    <div class="customerAddress d-flex w-100 align-items-center">
                                        ...
                                        <input type="text" id="customerAddress" class="flex-grow-1"
                                            style="border: none; outline: none;font-weight: normal;">
                                    </div>

                                    {{-- Customer Contact Number --}}
                                    <div class="customerContact w-100 d-flex w-100 align-items-center">
                                        <label for="customerContact" class="me-2">Contact&nbsp; &nbsp; &nbsp;:</label>
                                        <input type="text" id="customerContact" class="flex-grow-1"
                                            style="border: none; outline: none;font-weight: normal;">
                                    </div>
                                    {{-- ATTN --}}
                                    <div class="customerATN d-flex w-100 align-items-center">
                                        <label for="customerATN" class="me-2">ATTN &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                            :</label>
                                        <input type="text" id="customerATN" class="flex-grow-1"
                                            style="border: none; outline: none;font-weight: normal;">
                                    </div>
                            ...
                            <div class="d-flex flex-column gap-1" style="font-size:0.8rem;flex-basis:30%;">
                                ...
                                <div class="customerQNumber">
                                    ...
                                    <input type="text" id="customerQNumber" value="{{ $newQuotationNo }}"
                                        style="border: none; outline: none; width:130px; font-size:1.5rem; font-weight:bold;"
                                        readonly>
                                </div>
                                ...
                                <div class="customerDateIssued">
                                    ...
                                    <input type="text" id="customerDateIssued" value="{{ now()->toDateString() }}"
                                        style="border: none; outline: none; width:130px;" readonly>
                                </div>

                                {{-- Terms --}}
                                <div class="customerTerms">
                                    <label for="customerTerms" class="me-2">Terms&nbsp; &nbsp;:</label>
                                    <input type="text" id="customerTerms"
                                        style="border: none; outline: none; width:130px;">
                                </div>
                            </div>
                        ...
                        {{-- Quote --}}
                        <div class="mt-2">
                            <p class="fst-italic" style="font-size:0.8rem;">" We are happy to quote you the following
                                items you requested below..."</p>
                        </div>
                        ...
                        <div class="w-100">
                            <table class="table table-sm text-center" id="items-table">
                                <thead class="table-light" style="border:1px solid black;">
                                    <tr>
                                        <th scope="col"
                                            style="background-color: orange!important; border:none">Quantity
                                        </th>
                                        <th scope="col"
                                            style="background-color: orange!important; border:none">Unit</th>
                                        <th scope="col" class="text-start ps-2"
                                            style="background-color: orange!important; border:none">Item Name &
                                            Description</th>
                                        <th scope="col"
                                            style="background-color: orange!important; border:none">Unit Price
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[1][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[1][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td style="border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[1][item_name]"
                                                class="w-100 text-start item-name" style="text-transform: uppercase; background-color: rgb(226, 226, 226)">
                                        </td>

                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[1][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <input type="text" name="items[1][line_amount]"
                                                class="w-100 line-amount text-end" style="background-color: rgb(226, 226, 226) !important" disabled>
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[3][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[3][unit]" style="background-color: rgb(226, 226, 226)"> 
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[3][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>

                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[3][line_amount]" style="background-color: rgb(226, 226, 226) !important"
                                                class="w-100 line-amount text-end"  disabled>
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black; ">
                                            <input type="number" name="items[5][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[5][unit]" style="background-color: rgb(226, 226, 226)"> 
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td style="border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[5][item_name]"
                                                class="w-100 text-start item-name ps-1"
                                                style="text-transform: uppercase;background-color: rgb(226, 226, 226)">
                                        </td>

                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[5][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[7][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[7][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[7][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[9][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[9][unit]" style="background-color: rgb(226, 226, 226)"> 
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[9][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[11][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[11][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[11][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[13][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[13][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[13][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[15][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[15][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[15][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="width:30px; border-right:1px solid black; border-left:1px solid black; border-bottom:1px solid black;">
                                            <input type="number" name="items[17][quantity]" class="w-100 quantity" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <select class="w-100 unit-select" name="items[17][unit]" style="background-color: rgb(226, 226, 226)">
                                                <option value="" selected></option>
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit->units }}">{{ $unit->units }}</option>
                                                @endforeach
                                        ...
                                        <td
                                            style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                            <input type="text" name="items[17][unit_price]" class="w-100 unit-price" style="background-color: rgb(226, 226, 226)"
                                                oninput="calculateLineAmount(this)">
                                        </td>
                                ...
                                <td style="width:100px; border-right:1px solid black; border-bottom:1px solid black;">
                                    ...
                                    <tr class="bg-black" style="border: 1px solid black">
                                        ...
                                        <td class="text-end p-1 bg-secondary text-white fw-bold"
                                        ...
                                        <td class="p-1 bg-secondary">
                                            <div class="w-100 h-100 bg-secondary">
                                                <input id="totalAmount"
                                                    class="w-100 text-white fw-bold border-0 bg-transparent p-0 text-end"
                        ...
                        <div class="footer d-flex gap-2">
                            ...
                            <div class="w-75 h-50">
                                <div class="header bg-secondary d-flex align-items-center justify-content-evenly"
                                    style="height:30px;">
                                ...
                                <div class="h-100 w-100 d-flex" style="border:1px solid black;">
                                    ...
                                    <div class="p-2 w-75 d-flex flex-column gap-1" style="border-right:1px solid black;">
                                        ...
                                        <div class="row">
                                            <div class="col d-flex align-items-center">
                                                ...
                                                <input type="text" id="RD" class="form-control p-0 w-100"
                                                    style="font-size:0.8rem; width: auto; border:none; max-width:100%;"
                                                    value="Onstock">
                                    ...
                                    <div class="border w-50 p-2">
                                        <div class="row">
                                            <div class="col">
                                                <span class="fw-bolder me-2"
                                                    style="font-size:0.8rem;white-space: nowrap;">Price Effectivity:</span>
                                                <input type="text" id="PriceEffectivity"
                                                    class="form-control p-0 w-100"
                                                    style="font-size:0.8rem; width: auto; border:none;" value="1 Week">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="d-flex align-self-end gap-2">
                ...
                <button type="button" class="btn btn-info d-none"
                    style="font-size:0.6rem; width:80px; border-radius:3px;" data-is="123" id="updateBtn-customers">
                    <i class="fa-solid fa-floppy-disk" id="saveupdateIcon"></i>
                    <span id="updatebuttonText-customer">{{ __('Edit') }}</span>
                    <span id="updatebuttonSpinner-customer" class="spinner-border spinner-border-sm d-none"
                        role="status" aria-hidden="true"></span>

                    {{-- copy --}}
                    <button type="button" class="btn btn-info d-none"
                        style="font-size:0.6rem; width:80px; border-radius:3px;" data-copyID="123"
                        id="CopyBtn-customers">
                        <i class="fa-solid fa-floppy-disk" id="saveCopyIcon"></i>
                        <span id="CopybuttonText-customer">{{ __('Copy') }}</span>
                        <span id="CopybuttonSpinner-customer" class="spinner-border spinner-border-sm d-none"
                            role="status" aria-hidden="true"></span>
                    </button>

                    {{-- Png --}}
                    <button type="button" id="convertCustomerDetailsBtnToPNG"
                        class="btn bg-success text-white addButton" data-bs-toggle="modal"
                        style="font-size:0.6rem; width:80px; border-radius:3px;">
                    ...
                    <button type="button" class="btn btn-secondary"
                        ...
                        <span id="buttonSpinner-Quotation" class="spinner-border spinner-border-sm d-none" role="status"
                            aria-hidden="true"></span>
                    </button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="downloadImage" class="btn btn-primary">
                            ...
                            <span id="buttonSpinner-Quotationpng" class="spinner-border spinner-border-sm d-none"
                                role="status" aria-hidden="true"></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <button id="saveImageBtn" class="btn btn-primary" style="margin-top: 20px">
                            ...
                            <span id="buttonSpinner-QuotationEditHeadAndFooter"
