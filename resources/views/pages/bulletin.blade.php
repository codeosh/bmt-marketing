    ...
    <div class="h-100 w-100 rounded border">
      <div class="header d-flex rounded p-1 gap-2" style="height:37px; background-color:grey;">
        ...
        <div class="copyContents d-flex align-items-center justify-content-center">
          <button type="button" id="CopysaveBtn" class="btn btn-dark"
            style="font-size:0.6rem; width:100px; height:29px; border-radius:3px">
            <i class="fa-solid fa-copy" style="margin-right: 5px;"></i><span id="CopybuttonText">Copy</span>
            <span id="CopybuttonSpinner" class="spinner-border spinner-border-sm d-none" role="status"
