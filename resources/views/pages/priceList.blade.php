...
{{-- @push('scripts')
<script src="{{ asset('js/priceList-content')}}"></script> {{-- script to handle the click events for each list item.
When the user clicks on a list item, an AJAX request will be sent to the controller to fetch the content and display it
inside the #contentDisplay div. --}}
{{--@endpush --}}