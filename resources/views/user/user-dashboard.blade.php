    ...
    <body>
        ...
        <div class="home-div w-100">
            ...
            <div class="sidebar">
                ...
                {{-- Dashboard Button --}}
                <a href="{{ route('user-dashboard-page')}}" class="{{ Request::routeIs('user-dashboard-page') ? 'active' : '' }}">
                    <div
                ...
                <hr>
                <a href="{{ route('user-bulletin.index')}}"
                    class="{{ Request::routeIs('user-bulletin.index') ? 'active' : '' }}">
                    <div
                ...
                <a href="{{ route('user-postTemplate.index') }}"
                    class="{{ Request::routeIs('user-postTemplate.index') ? 'active' : '' }}">
                    <div
                ...
                <a href="{{route('user-replyTemplate.index')}}"
                    class="{{ Request::routeIs('user-replyTemplate.index') ? 'active' : '' }}">
                    <div
                        class="side-bar input-group mt-1 d-flex align-items-center justify-content-center border rounded">
                ...
                <hr>
                <a href="{{route('user-priceList.index')}}"
                    class="{{ Request::routeIs('user-priceList.index') ? 'active' : '' }}">
                    <div
                ...
                <a href="{{route('user-quotation.index')}}"
                    class="{{ Request::routeIs('user-quotation.index') ? 'active' : '' }}">
                    <div
                        class="side-bar input-group mt-1 d-flex align-items-center justify-content-center border rounded">
                ...
                <a href="{{route('user-prospects.index')}}"
                    class="{{ Request::routeIs('user-prospects.index') ? 'active' : '' }}">
                    <div
                        class="side-bar input-group mt-1 d-flex align-items-center justify-content-center border rounded">
                ...
                <hr>
                <a href="{{route('user-insight.index')}}"
                    class="{{ Request::routeIs('user-insight.index') ? 'active' : '' }}">
                    <div
                ...
                <a href="{{route('user-guides.index')}}"
                    class="{{ Request::routeIs('user-guides.index') ? 'active' : '' }}">
                    <div
                        class="side-bar input-group mt-2 d-flex align-items-center justify-content-center border rounded">
                        ...
                        <div class="dropdown h-100 w-100 d-flex align-items-center justify-content-end">
                            <button type="button" class="h-100 d-flex justify-content-between align-items-center"
                                ...
                                <div class="h-100 d-flex align-items-end justify-content-between flex-column"
                                    ...
                                    <small class="text-muted align-self-end" style="font-size:0.6rem;">User</small>
                                </div>
