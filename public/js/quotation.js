...
$(document).ready(function () {
    ...
    $("#quotationTable tbody").on("click", ".quote-row", function () {
        ...
        let showCustomerINfo =
            Laravel.user_role === "admin"
                ? `/admin-quotation/${quoteId}`
                : `/user-quotation/${quoteId}`;
    ...
    $("#deleteBtn").on("click", function () {
        let deleteQuote =
            Laravel.user_role === "admin"
                ? `/admin-quotation/${selectedRowId}`
                : `/user-quotation/${selectedRowId}`;
    ...
    .bg-black td:last-child input {
        ...
        padding: 5px !important;
                ...
                /* Ensure background color applies to even table rows */
                ...
                /* Apply background color to inputs and selects inside even rows */
                ...
                /* Ensure inputs and selects in odd rows remain white */
    ...
    $("#saveImageBtn").on("click", function () {
        ...
        let updateIMG =
            Laravel.user_role === "admin"
                ? `/update-image/${quotationId}`
                : `/user-update-image/${quotationId}`;
    ...
    $("#updateBtn-customers").on("click", function (e) {
        ...
        let edit =
            Laravel.user_role === "admin"
                ? `/admin-quotation/${quoteIdupdate}`
                : `/user-quotation/${quoteIdupdate}`;
